...
public class ChubbyCheeksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chubby_cheeks);
        ...
        mp=new MediaPlayer();
        mp= MediaPlayer.create(this,R.raw.chubbychicks);
