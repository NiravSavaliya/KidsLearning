...
public class TwinkleLittleStarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twinkle_little_star);
        ...
        mp=new MediaPlayer();
        mp= MediaPlayer.create(this,R.raw.twinkletwinkle);
