...
public class IamLittleTeapotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iam_little_teapot);
        ...
        mp=new MediaPlayer();
        mp= MediaPlayer.create(this,R.raw.imlittleteapot);
