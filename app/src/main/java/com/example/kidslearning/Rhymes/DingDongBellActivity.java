...
public class DingDongBellActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ding_dong_bell);
        ...
        mp=new MediaPlayer();
        mp= MediaPlayer.create(this,R.raw.dingdongbell);
