...
public class SeaAnimalAdapter extends BaseAdapter
{
    Context context;
    final String[] name;
    final int[] image;
    ...
    public SeaAnimalAdapter(Context context, String[] name, int[] image) {
        this.name = name;
        this.image = image;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        SeaAnimalAdapter.Holder holder = new SeaAnimalAdapter.Holder();
        View rowView;
