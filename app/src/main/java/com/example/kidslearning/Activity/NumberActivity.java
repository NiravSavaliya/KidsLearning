...
public class NumberActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NumberActivity.this,DashboardActivity.class);
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA
                ...
                Toast.makeText(NumberActivity.this, "This Language is not supported", Toast.LENGTH_SHORT).show();
            } else {
